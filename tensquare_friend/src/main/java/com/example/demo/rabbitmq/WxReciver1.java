...
@Component
@Slf4j
@RabbitListener(queues = "wx_temp_msg_queue1", containerFactory = "firstFactory")
public class WxReciver1 implements ChannelAwareMessageListener {
	...
	public void onMessage(Message message, Channel channel) throws Exception {
		...
		System.out.println("线程名字--22--" + Thread.currentThread().getName());
		lock();
...
//		String s = i.equals("0") ? "成功" : "失败";
		...
		log.info("capp的返回结果--22--:" + s + "capp的下标:" + sourceData.get("remark"));
